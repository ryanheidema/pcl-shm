...
struct customAllocatorPointCloudTest : public testing::Test {
  protected:
    CustomAllocatorPointCloud<PointXYZ, std::allocator<PointXYZ> > *cloud;

  void SetUp() override
  {
    cloud = new CustomAllocatorPointCloud<PointXYZ, std::allocator<PointXYZ> >(std::allocator<PointXYZ>());
  }
};
